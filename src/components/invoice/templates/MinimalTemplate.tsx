      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.companyInfo}>
            ...
            {invoiceData.companyPhone && (
              <Text style={styles.subtitle}>{invoiceData.companyPhone}</Text>
            )}
          </View>
        ...
        <View style={styles.totals}>
          ...
          <View
            style={[
              styles.totalRow,
              { marginTop: 8, paddingTop: 8, borderTop: "1px solid #000" },
            ]}
          >
        ...
        <View style={styles.section}>
          ...
          {invoiceData.bankAccount && (
            <Text style={styles.value}>Account: {invoiceData.bankAccount}</Text>
          )}
        </View>
